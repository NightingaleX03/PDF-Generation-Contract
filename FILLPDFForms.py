...
API_KEY = "sarahmathew2003@gmail.com_7x6t5XPkF3MV0pf0E3Kmk6LJKnvGh8RM4hW03a9MTteu7hL429f6YRJF5uWrMW5N"
...
SourceFileUrl = "filetoken://01233e9ff78117065c09464bdba9b3fe54e6e6b6667ba0707d"

# PDF document password. Leave empty for unprotected documents.
Password = ""

# Destination PDF file name
DestinationFile = ".\\rentalAgreement.pdf"
...
FieldsStrings = "1;topmostSubform[0].Page1[0].FilingStatus[0].f1_01[0];{req.body.landlord_name}|1;topmostSubform[0].Page1[0].Dependents[0].Table_Dependents[0].Row1[0].f1_14[0];{req.body.retail_unit}|1;topmostSubform[0].Page1[0].Dependents[0].Table_Dependents[0].Row1[0].f1_15[0];{req.body.street_number}|1;topmostSubform[0].Page1[0].Dependents[0].Table_Dependents[0].Row1[0].f1_16[0];{req.body.street_name}"
